...
> Star Citizen の全テキスト（約 10 万行）を翻訳する場合、Haiku で $1〜3 程度、Sonnet で $5〜15 程度が目安です。
...
| Tier | 条件 | RPM 上限 | TPM 上限（Haiku） |
|---|---|---|---|
| **Tier 1** | $5 クレジット購入 | 50 RPM | 50,000 TPM |
| **Tier 2** | $40 以上の支払い + 7 日以上 | 1,000 RPM | 100,000 TPM |
| **Tier 3** | $200 以上の支払い + 30 日以上 | 2,000 RPM | 200,000 TPM |
| **Tier 4** | $400 以上の支払い + 60 日以上 | 4,000 RPM | 400,000 TPM |

大量翻訳バッチを走らせる場合は、Console の **「Settings」→「Limits」** から現在の上限を確認してください。Tier 昇格は自動で行われます。
